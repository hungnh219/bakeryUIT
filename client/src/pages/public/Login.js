...
const Login = () => {
  ...
  return (
    <div className='bg-[url("https://png.pngtree.com/thumb_back/fh260/background/20240106/pngtree-deliciously-textured-bakery-shop-instagram-posts-image_13928076.png")] w-screen h-screen flex justify-center'>
      {isVerifiedEmail && (
